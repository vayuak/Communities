...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                // 1. Block direct network access using the Shield Key
                .addFilterBefore(shieldHandshakeFilter, UsernamePasswordAuthenticationFilter.class)
                // 2. Parse the JWT to populate controller request attributes
                .addFilterAfter(jwtAuthenticationFilter, ShieldHandshakeFilter.class)
                .authorizeHttpRequests(auth -> auth
                        // 🟢 FIXED: Let the Gateway handle JWT blocking. The internal service permits all routed traffic.
